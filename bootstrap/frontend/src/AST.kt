...
class ASTFunction(parent: ASTCodeBlock, val name: String, val affix: String, val affixPos: int, val returnType: ASTType, parameters: List<ASTParameter>) : ASTNode(parent)
